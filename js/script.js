$(document).ready(function(){
	...
	$('.more__world>a').on("click" , function(e){
		$('html').animate({ 
	            scrollTop: $(".ad__block").offset().top
	        }, 900 );
	});
	...
	$(".scrollable__button").on("click" ,function(e){
		...
		if ($("#" + $(this).attr("data-block")).length) {
			...
			if ($(this).attr("data-block") == "home") {
				...
				$('html').animate({ 
		            scrollTop: $("#" + $(this).attr("data-block")).offset().top  + 20
		        }, 900 );
			}
